...
do_vulcan_sync() {
  ...
  for middleware in ${HOME}/Projects/Octoblu/the-stack-env-production/hpe/vulcan/${project_name}/middlewares/*; do
...
sync_backend(){
  local vulcan_url="$1"
  local project_name="$2"
  local args=$(cat "${HOME}/Projects/Octoblu/the-stack-env-production/hpe/vulcan/${project_name}/backend")
...
sync_frontend(){
  local vulcan_url="$1"
  local project_name="$2"
  local args=$(cat "${HOME}/Projects/Octoblu/the-stack-env-production/hpe/vulcan/${project_name}/frontend")
